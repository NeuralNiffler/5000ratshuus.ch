...
- Themen-Tags (Bildung, Finanzen, Wohnen, Umwelt, Wahlen, ...) immer direkt beim jeweiligen Geschäft zeigen: im Fliesstext-Artikel als Tag-Liste am Ende des Geschäfts, in Tabellen als eigene Spalte. Nie als lose Tag-Wolke ohne Zuordnung zu einem Geschäft, das verwirrt mehr als es hilft.
